package radius.suser.controller;
...
public class SuserController {
	...
	@Resource(name="radius.suser.suserService")
	...
	public String suser(@ModelAttribute("suserVo") SuserVo suserVo, HttpServletRequest request, HttpServletResponse response
		...
		int totalCnt = this.suserService.getTotalSuserList(suserVo).size();
	...
	public HashMap<String, Object> suserAdd(SuserVo suserVo,HttpServletRequest request) throws Exception {
    ...
    @RequestMapping(value = "suserSetUpdateData.ajax", method = RequestMethod.POST)
 	public HashMap<String, Object> suserSetUpdateData(@RequestParam HashMap<String, Object> req) throws Exception {
	...
	public HashMap<String, Object> suserUpdate(SuserVo suserVo,HttpServletRequest request) throws Exception {
	...
	public HashMap<String, Object> suserDelete(SuserVo suserVo,HttpServletRequest request) throws Exception {
	...
	public void suserExcelDownload(HttpServletResponse response, final HttpSession session, SuserVo suserVo) throws Exception {
		...
		try {	
			...
			String[] l_aColumns = {"운영자 ID", "이름", "설명"};
			
			String xlsName = "RADIUS 운영자 관리";
			...
			for(SuserVo vo : excelList){
				...
				row.createCell(colIdx++).setCellValue(vo.getUserId());
