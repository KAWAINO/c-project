...
<script type="text/javascript" src="/web/js/swUpdate/swUpdate.js"></script>
...
<body>
	...
	<section class="contents-area">
		<header>
			...
			<h2><spring:message code="update.updateSchedule" /></h2>
		</header>
		<div class="board-area" id="div_contents">
			<form name="searchSwUpdateForm" id="searchSwUpdateForm" method="post">
	            <table class="tbl-default bg-on">
                    ...
                    <tbody id="trafficTableBody">
	                    <c:choose>
	                        <c:when test="${fn:length(swUpdateList) > 0 }">
	                            <c:forEach var="item" items="${swUpdateList }" varStatus="idx">
	                                <tr id="list_${item.seq_sw_sch }" onClick="goUpdate('${item.seq_sw_sch}')">
...
<!-- 추가 Modal -->
        <div class="modal fade" id="addModal" data-bs-backdrop="static">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
             <div class="modal-content">
                <form name="addSwUpdateForm" id="addSwUpdateForm" method="post">
                     <section class="contents-area">
                            <header>
        ...
        <div class="modal fade" id="updateModal" data-bs-backdrop="static">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
             <div class="modal-content">
                <form name="updSwUpdateForm" id="updSwUpdateForm" method="post">
                     <input type="hidden" id="seq_sw_sch" name="seq_sw_sch" value="">
